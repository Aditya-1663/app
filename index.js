...
//     res.render("aditya",{userdata:data})  
// })
...
io.on('connection',socket =>{
    ...
    socket.on('send',(message,userid,name12)=>{
        // console.log("revid",socket) 
        // console.log("revid:",userid) 
        // const recipientSocket = io.sockets.sockets.find(
        //     userid
        //   );
        const recipientSocketId = Object.keys(socketToUserIdMap).find(
